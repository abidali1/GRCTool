...
// import MiniFramework from '../../components/Store/MiniFramework';
...
class Navigation extends React.PureComponent {
  componentDidMount() {
    ...
    this.props.fetchStoreDomains();
  }

  toggleFramewok() {
    this.props.fetchStoreFrameworks();
    this.props.toggleDomain();
  }
  ...
  renderSuggestion(suggestion, { query, isHighlighted }) {
    ...
    return (
      <Link to={`/control/${suggestion.slug}`}>
          ...
          <Container>
            <Row>
              ...
              <Col md='4' className='text-center d-none d-md-block'>
                ...
                <span>Contact Us 951-999-9999</span>
              </Col>
                      ...
                      <DropdownMenu right className='nav-brand-dropdown'>
                        <div className='mini-brand'>
                          <MiniFramework
                            ...
                            toggleFramework={() => this.toggleFramewok()}
                          />
                        </div>
                      </DropdownMenu>
                    </Dropdown>
...
const mapStateToProps = state => {
  return {
    ...
    isFrameworkOpen: state.navigation.isFrameworkOpen,
    cartItems: state.cart.cartItems,
    frameworks: state.framework.storeFrameworks,
    domains: state.domain.storeDomains,
