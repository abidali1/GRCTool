...
class ControlsShop extends React.PureComponent {
  componentDidMount() {
    const slug = this.props.match.params.slug;
    this.props.filterControls(slug);
  }
...
export default connect(mapStateToProps, actions)(ControlsShop);
