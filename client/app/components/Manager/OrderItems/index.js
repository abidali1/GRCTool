  ...
  const renderItemsAction = item => {
    ...
    if (item.status === 'Delivered') {
      ...
      if (!isAdmin) {
        return (
          <DropdownConfirm label='Cancel'>
            <div className='d-flex flex-column align-items-center justify-content-center p-2'>
              <p className='text-center mb-2'>{`Are you sure you want to cancel ${item.control?.name}.`}</p>
              <Button
                variant='danger'
        ...
        return (
          <DropdownConfirm
            label={item.control && item.status}
              ...
              <div className='d-flex justify-content-between flex-column flex-md-row'>
                <div className='d-flex align-items-center box'>
                  <img
                    ...
                    src={`${
                      item.control && item.control.imageUrl
                        ? item.control.imageUrl
                        ...
                        <>
                          ...
                          <div className='d-flex align-items-center justify-content-between'>
                            <span className='price'>
                              ${item.purchasePrice || item.control.price}
                            </span>
                          </div>
                        </>
                      ) : (
