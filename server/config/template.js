...
exports.clientSignup = (host, { resetToken, email }) => {
  const message = {
    ...
    text: `${
      ...
      'Please click on the following link, or paste this into your browser to complete the process:\n\n' +
      'http://'
    }${host}/client-signup/${resetToken}?email=${email}\n\n`
  };

  return message;
};

exports.regulatorSignup = (host, { resetToken, email }) => {
  const message = {
    subject: 'Regulator Registration',
    text: `${
      'Congratulations! Your application has been accepted. Please complete your Merchant account signup by clicking on the link below. \n\n' +
      'Please click on the following link, or paste this into your browser to complete the process:\n\n' +
      'http://'
    }${host}/regulator-signup/${resetToken}?email=${email}\n\n`
  };

  return message;
};
exports.implementerSignup = (host, { resetToken, email }) => {
  const message = {
    subject: 'Regulator Registration',
    text: `${
      'Congratulations! Your application has been accepted. Please complete your Merchant account signup by clicking on the link below. \n\n' +
      'Please click on the following link, or paste this into your browser to complete the process:\n\n' +
      'http://'
    }${host}/implementer-signup/${resetToken}?email=${email}\n\n`
  };

  return message;
};
exports.clientWelcome = name => {
  const message = {
...
exports.implementerWelcome = name => {
  const message = {
    subject: 'Implementer Registration',
    text:
      `Hi ${name}! Congratulations! Your application for merchant account has been accepted. \n\n` +
      `It looks like you already have a member account with us. Please sign in with your member credentials and you will be able to see your merchant account.`
  };
...
exports.clientApplicationEmail = () => {
  const message = {
    subject: 'Register as a regulatory body',
